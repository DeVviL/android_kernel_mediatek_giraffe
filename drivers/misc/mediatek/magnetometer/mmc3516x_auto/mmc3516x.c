...
static ssize_t  show_sensordata_calidata(struct device_driver *ddri, char *buf)
{
	int tmp[3];
	char strbuf[MMC3516X_BUFSIZE];
// \CB\D5 \D3\C2 2014\C4\EA06\D4\C209\C8\D5 11:49:08	tmp[0] = sensor_data[4]* 1000*CONVERT_M/CONVERT_M_DIV;				
// \CB\D5 \D3\C2 2014\C4\EA06\D4\C209\C8\D5 11:49:08	tmp[1] = sensor_data[5]* 1000*CONVERT_M/CONVERT_M_DIV;
// \CB\D5 \D3\C2 2014\C4\EA06\D4\C209\C8\D5 11:49:08	tmp[2] = sensor_data[6]* 1000*CONVERT_M/CONVERT_M_DIV;
